...
BINARY:
    debugging helps:
        ...
        Never omit stack frames in backtraces:
            < 0176 E5C0: 85 DB 75 5C 41 83 FC 32  44 89 E0 72 15 4C 89 FF  ..u\A..2 D..r.L..
            > 0176 E5C0: 85 DB 90 90 41 83 FC 32  44 89 E0 72 15 4C 89 FF  ....A..2 D..r.L..
    ...
    do not assert bytesRead in OsReadFile but just don't write (for local framexml.toc):
        < 00EE CCE0: 48 85 F6 74 31 4D 85 FF  74 4E 44 89 F2 E8 96 BA  H..t1M.. tND.....
        < 00EE CCF0: A9 00 48 89 C3 48 85 DB  79 33 E8 01 B5 A9 00 8B  ..H..H.. y3......
        < 00EE CD00: 38 85 FF 75 66 48 83 FB  FF 75 22 41 C7 07 00 00  8..ufH.. .u"A....
        < 00EE CD10: 00 00 30 DB EB 48 48 8D  3D 3F 24 B8 00 48 8D 15  ..0..HH. =?$..H..
        < 00EE CD20: C3 F6 AD 00 30 DB BE A4  01 00 00 EB 20 41 89 1F  ....0... .... A..
        < 00EE CD30: 44 39 F3 0F 94 C3 EB 26  48 8D 3D 1D 24 B8 00 48  D9.....& H.=.$..H
        < 00EE CD40: 8D 15 BE 7C B6 00 30 DB  BE A5 01 00 00 30 C0 E8  ...|..0. .....0..
        < 00EE CD50: 6C 1A 43 FF BF 57 00 00  00 E8 62 1B 43 FF 88 D8  l.C..W.. ..b.C...
        < 00EE CD60: 48 83 C4 08 5B 41 5E 41  5F 5D C3 E8 56 BB A9 00  H...[A^A _]..V...
        < 00EE CD70: 48 8D 3D E5 23 B8 00 48  8D 15 79 26 B8 00 48 8D  H.=.#..H ..y&..H.
        < 00EE CD80: 0D 84 26 B8 00 4C 8D 05  A4 26 B8 00 BE A8 01 00  ..&..L.. .&......
        < 00EE CD90: 00 49 89 C1 30 C0 E8 15  2C 43 FF 84 C0 0F 84 62  .I..0... ,C.....b
        < 00EE CDA0: FF FF FF CC E9 5C FF FF  FF 0F 1F 80 00 00 00 00  .....\.. ........
        > 00EE CCE0: 48 85 F6 74 31 90 90 90  90 90 44 89 F2 E8 96 BA  H..t1... ..D.....
        > 00EE CCF0: A9 00 48 89 C3 48 85 DB  79 33 E8 01 B5 A9 00 8B  ..H..H.. y3......
        > 00EE CD00: 38 85 FF 75 6C 48 83 FB  FF 75 22 41 C7 07 00 00  8..ulH.. .u"A....
        > 00EE CD10: 00 00 90 90 EB 48 48 8D  3D 3F 24 B8 00 48 8D 15  .....HH. =?$..H..
        > 00EE CD20: C3 F6 AD 00 30 DB BE A4  01 00 00 EB 20 4D 85 FF  ....0... .... M..
        > 00EE CD30: 74 2C 41 89 1F 90 EB 26  CC CC CC CC CC CC CC CC  t,A....& ........
        > 00EE CD40: CC CC CC CC CC CC CC CC  CC CC CC CC CC 30 C0 E8  ........ .....0..
        > 00EE CD50: 6C 1A 43 FF BF 57 00 00  00 E8 62 1B 43 FF 44 39  l.C..W.. ..b.C.D9
        > 00EE CD60: F3 0F 94 C3 88 D8 48 83  C4 08 5B 41 5E 41 5F 5D  ......H. ..[A^A_]
        > 00EE CD70: C3 E8 50 BB A9 00 48 8D  3D DF 23 B8 00 48 8D 15  ..P...H. =.#..H..
        > 00EE CD80: 73 26 B8 00 48 8D 0D 7E  26 B8 00 4C 8D 05 9E 26  s&..H..~ &..L...&
        > 00EE CD90: B8 00 BE A8 01 00 00 49  89 C1 30 C0 E8 0F 2C 43  .......I ..0...,C
        > 00EE CDA0: FF 90 90 90 90 90 90 90  90 90 90 90 90 90 90 90  ........ ........
